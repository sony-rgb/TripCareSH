...
export default function BookingTime({
  ...
  const [checkInTimeState, setCheckInTime] = useState(checkInTime);
  const [checkOutTimeState, setCheckOutTime] = useState(checkOutTime);
        ...
        {renderCalendar && (
          <View
            ...
            <Calendar
              ...
              current={startMode ? checkInTimeState : checkOutTimeState}
              minDate={minDate}
              maxDate={maxDate}
              onDayPress={day => {
